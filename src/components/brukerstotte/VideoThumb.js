...
const VideoThumb = ({videoTitle, urlFriendlyName, videoHeaderImageUrl, videoDurationText, videoUrl, modalTitle, modalContent, show}) => {
        ...
        return (
            <div className="video-thumb-parent">
                    ...
                    <div className="info">
                        ...
                        { modalContent &&
                            <div className="center priority-click">
                                <div style={{textDecoration: 'underline'}} onClick={(e) => {handleOpenHelperModal(); e.stopPropagation();}}>
                                    { modalTitle }
                                </div>
                            </div>}
                ...
                <ReactModal
                    ...
                    >
                    <img src={cross} className="img-close-modal-icon-internal" alt="Lukk" onClick={handleCloseHelperModal} />
